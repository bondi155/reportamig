...
import { pdTableHeadersTotal, cobexcTableHeadersTotal, gtosopTableHeadersTotal, orvasTableHeadersTotal, indGestionHeadersTotal, roeHeadersTotal } from '../charts/SecondGridEvalData.js'
        ...
        <Form className='mb-3 mt-5'>
          ...
          >
            <Tab eventKey='pd' title={<span className={tabKey === 'pd' ? 'active' : 'inactive'}>PD</span>} style={{ fontWeight: 600 }}>
              <SecondGridEval headers={pdTableHeadersTotal} data={axiosResponse && axiosResponse.data && axiosResponse.data[0]} />
            </Tab>
            <Tab eventKey='cobexc' title={<span className={tabKey === 'cobexc' ? 'active' : 'inactive'}>COB_EXC</span>} style={{ fontWeight: 600 }}>
              <SecondGridEval headers={cobexcTableHeadersTotal} data={axiosResponse && axiosResponse.data && axiosResponse.data[1]} />
            </Tab>
            <Tab eventKey='gtosop' title={<span className={tabKey === 'gtosop' ? 'active' : 'inactive'}>GTOSOP</span>} style={{ fontWeight: 600 }}>
              <SecondGridEval headers={gtosopTableHeadersTotal} data={axiosResponse && axiosResponse.data && axiosResponse.data[2]} />
            </Tab>
